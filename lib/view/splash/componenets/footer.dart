    ...
    return Container(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          // If the screen width is less than a certain size, use a column layout for the footer
          if (constraints.maxWidth < 600) {
            return Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => launchUrl(
                      Uri(scheme: 'mailto', path: 'cnem.technichal@gmail.com')),
                  child: Tooltip(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'الشبكة التعانية للتسويق الالكتروني --2024-- ',
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 14,
                          fontWeight: FontWeight.bold),
